          ...
          <Col xs={12} sm={6} md={4} lg={3} className="d-flex justify-content-center mb-4">
            <Card style={{ width: '18rem' }}>
              ...
              <Card.Body>
                ...
                <Card.Text style={{ height: '13', justifyContent: 'flex-start', fontWeight: '', fontStyle: 'normal' }}>
                  Aracruz
                  <br />
                  Presencial
                  <br />
                  40 horas
                  <br />
                  Início em 14/04/2025
                  <CardText style={{ color: 'blue', textJustify: 'revert-layer' }}>
                    <p>Em até 1x de R$389,90</p>
                    <p style={{ fontSize: '12px' }}>Valor total do curso r$ 389,00 em 01x s/Juros R$ 389,00</p>
                  </CardText>
                </Card.Text>
            ...
            <Card style={{ width: '18rem' }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  <CardText style={{ color: 'blue', textJustify: 'revert-layer' }}>
                    <p>Em até 1x de R$428,73</p>
                    <p style={{ fontSize: '12px' }}>Valor total do curso r$ 428,73 em 01x s/Juros R$  428,73</p>
                  </CardText>
                </Card.Text>
                <Button variant="primary" style={{ width: '100%', backgroundColor: '#3840BA' }}>Matricule-se</Button>
              </Card.Body>
